...
@Component({
  selector: 'LogEntry-home',
  templateUrl: './LogEntry-home.component.html',
  styleUrls: ['./LogEntry-home.component.scss']
})
export class LogEntryHomeComponent implements AfterViewInit {
