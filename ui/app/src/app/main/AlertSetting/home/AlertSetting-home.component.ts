...
@Component({
  selector: 'AlertSetting-home',
  templateUrl: './AlertSetting-home.component.html',
  styleUrls: ['./AlertSetting-home.component.scss']
})
export class AlertSettingHomeComponent implements AfterViewInit {
