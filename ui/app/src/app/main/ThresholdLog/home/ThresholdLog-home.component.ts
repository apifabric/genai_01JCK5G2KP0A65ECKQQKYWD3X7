...
@Component({
  selector: 'ThresholdLog-home',
  templateUrl: './ThresholdLog-home.component.html',
  styleUrls: ['./ThresholdLog-home.component.scss']
})
export class ThresholdLogHomeComponent implements AfterViewInit {
