...
@Component({
  selector: 'CpuUsage-home',
  templateUrl: './CpuUsage-home.component.html',
  styleUrls: ['./CpuUsage-home.component.scss']
})
export class CpuUsageHomeComponent implements AfterViewInit {
