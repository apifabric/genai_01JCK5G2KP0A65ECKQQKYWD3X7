...
@Component({
  selector: 'SystemMetric-home',
  templateUrl: './SystemMetric-home.component.html',
  styleUrls: ['./SystemMetric-home.component.scss']
})
export class SystemMetricHomeComponent implements AfterViewInit {
