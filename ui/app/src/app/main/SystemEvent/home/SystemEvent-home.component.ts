...
@Component({
  selector: 'SystemEvent-home',
  templateUrl: './SystemEvent-home.component.html',
  styleUrls: ['./SystemEvent-home.component.scss']
})
export class SystemEventHomeComponent implements AfterViewInit {
